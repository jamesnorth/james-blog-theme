...
<footer id="site-footer">
    <div class="container d-flex">
        <div class="me-auto">
            <p class="footer-copyright">&copy; <?php echo date_i18n('Y'); ?>, <a href="<?php echo site_url(); ?>">James North</a></p>
        </div>  
        <div>
            <p><a href="#"><span>Back to top </span><span class="arrow" aria-hidden="true">&uarr;</span></a></p>
        </div>
    </div>
